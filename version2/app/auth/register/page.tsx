...
import { Package2, Loader2, AlertCircle, Wifi, WifiOff, Truck, User } from "lucide-react"
...
export default function RegisterPage() {
  ...
  const { register, loading, isConnected, checkConnection } = useAuth()
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/50 p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        {/* Connection Status */}
        <div className={`flex items-center justify-center gap-2 text-sm ${isConnected ? "text-emerald-500" : "text-amber-500"}`}>
          {isConnected ? (
            <>
          ...
          <CardContent>
            <form className="space-y-4" onSubmit={handleRegister}>
              ...
              <div className="space-y-3">
                ...
                <RadioGroup
                  value={role}
                  onValueChange={(value) => setRole(value as "requester" | "provider")}
                ...
                >
                  ...
                  >
                    ...
                    <div className={`flex h-10 w-10 items-center justify-center rounded-full ${
                      role === "requester" ? "bg-primary text-primary-foreground" : "bg-muted"
                    }`}>
                  ...
                  >
                    ...
                    <div className={`flex h-10 w-10 items-center justify-center rounded-full ${
                      role === "provider" ? "bg-primary text-primary-foreground" : "bg-muted"
                    }`}>
                      <Truck className="h-5 w-5" />
                    </div>
                    <span className="font-medium text-sm">Deliver Parcels</span>
                    <span className="text-xs text-muted-foreground text-center">
                      Become a driver
                    </span>
                  </Label>
